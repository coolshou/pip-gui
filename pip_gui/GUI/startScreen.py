...
from PyQt5.QtWidgets import (QTabWidget, QWidget, QLabel, QVBoxLayout, 
                             QHBoxLayout, QRadioButton, QSpacerItem, QSizePolicy,
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.radioInstall = QRadioButton(self.verticalLayoutWidget)
        ...
        self.radioPy2 = QRadioButton(self.horizontalLayoutWidget_2)
        self.radioPy2.setObjectName(_fromUtf8("radioPy2"))
        #self.radioPy2.setChecked(False)
        #self.radioPy2.setAutoExclusive(False)
        self.horizontalLayout_2.addWidget(self.radioPy2)
        self.radioPy3 = QRadioButton(self.horizontalLayoutWidget_2)
        self.radioPy3.setObjectName(_fromUtf8("radioPy3"))
        #self.radioPy3.setAutoExclusive(False)
        #self.radioPy3.setChecked(True)
        #self.radioPy3.setAutoExclusive(True)
        ...
        self.actionPIP_GUI = QAction(mainWindow)
